package net.villagerzock.createcoasterseats.icons;
...
public class SeatsAllIcons extends AllIcons {
    ...
    private static SeatsAllIcons next() {
        return new SeatsAllIcons(++x, y);
    }

    private static SeatsAllIcons newRow() {
        return new SeatsAllIcons(x = 0, ++y);
    }
